...
function  create() {
    ...
    kd.innerText = 'https://342u4133v7.goho.co/?id='+myid.value+'&url='+url.value; //www.baidu.com
}
</script>
<div id="bob">
...
<div id="bds">
	...
	<img src="images/luyuz.png"></div></a>
...
<div class="mianban">
            ...
            <div class="content-slide">
                <div class="purchase_from">
					<ul id="Open" style="display:block;">
						...
						<div class="alert alert-success"><!--www.baidu.com !-->
                    ...
                    <ul id="Back" style="display:none;">
						...
						<!-- </center> -->
						<div class="list-group-item text-center"><!--www.baidu.com !-->
					  
						</div>
                        <span id="Order"></span><!--www.baidu.com !-->
                    </ul>
                </div>
            </div>
        </div>
    ...
    <p style="text-align:center"><br><a style="color: #FFFFFF"></a></p><br><!--www.baidu.com !-->
</div>
<div id="loading"></div>
	</div>
	</div><!--www.baidu.com !-->
